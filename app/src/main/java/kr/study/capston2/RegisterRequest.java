...
public class RegisterRequest extends StringRequest {
    ...
    public RegisterRequest(String userID, String userPassword, String userPassword2, String userName ,String userMail, int userAge, Response.Listener<String> listener) {
